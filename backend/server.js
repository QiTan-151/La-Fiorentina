...
app.use(helmet({ crossOriginResourcePolicy: { policy: 'cross-origin' } })); // cho phép frontend domain khác load ảnh
app.use(express.json({ limit: '10kb' }));

// Phục vụ ảnh món ăn đã upload — công khai, không cần xác thực (giống ảnh trên menu thật)
