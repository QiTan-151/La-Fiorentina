...
export const dishSchema = z.object({
  ...
  description_en: z.string().trim().max(300, 'Mô tả tiếng Anh quá dài').optional().or(z.literal('')),
  ...
  image_url: z.string().trim().max(500, 'URL ảnh quá dài').optional().or(z.literal('')).nullable(),
